import { ChangeDetectionStrategy, ChangeDetectorRef, Component, OnDestroy, OnInit, ViewEncapsulation, ViewChild, ElementRef } from '@angular/core';
...
@Component({
    selector       : 'diseno-list',
    templateUrl    : './list.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DisenoListComponent implements OnInit, OnDestroy
{
    categories: Category[];
    courses: Course[];
    ...
    ngOnInit(): void
    {
        ...
        this._coursesService.getCursosEtapa('Diseño')
          .subscribe(
            data => {
                let courses: any = [];
                for(let c in data){
